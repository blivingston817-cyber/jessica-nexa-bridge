...
D) VAGUE / CONFUSED / SHORT / "I don't know" / "someone called me" / silence:
   → Ask ONLY: "Are you a homeowner right now?"
     • YES → Say: "We reached out because you had previously requested info on some loan options. Does that ring a bell?"
         ...
         - NO (doesn't ring a bell / unsure) → Deliver this pitch naturally, conversationally — one thought at a time: "No worries at all. So what we're seeing a lot of right now is homeowners who are carrying high-interest debt — credit cards running 28, 29, even 30 percent, personal loans, car loans — and even though their mortgage rate might already be low, that high-interest debt is quietly eating away at their monthly cash flow. What a lot of people are finding is that by rolling that debt into their mortgage, they're cutting their total monthly outflow dramatically — we're talking some clients saving a thousand, two thousand dollars a month or more — because instead of paying 29% on a credit card, they're now paying their mortgage rate on that same balance. The overall monthly picture looks completely different. How much debt do you think you're carrying right now across all of it — credit cards, car, personal loans? An estimate is totally fine." → Wait for their answer, then say: "Got it, so roughly [AMOUNT THEY SAID]. And would you also want to pull out a little extra cash at closing — maybe for a rainy day fund, home improvements, or anything else going on?" → Then go straight into MORTGAGE INTAKE. CRITICAL: Do NOT re-ask any question they already answered. Use their debt amount as the answer to the cash-out/goal question. Carry all answers forward.
